...
def PostThrusterData(leftThruster, rightThruster):
    UNAME = 'Thruster'
    URL = 'http://192.168.2.10:9026/Thruster'
...
# 목표 위치 설정
finalTargetX = [8.5 , 3.5, 3.2 , 5.3]
#[8.5 , 2.5 , 2.5 , 2.5 , 7.5]
finalTargetY = [37.7, 39.6, 25 , 0.8]
#[33.1, 33.1, 19.7, 6   , 2.5]
...
while Running:
    ...
    try:
        ...
        if count_for_finalTarget == 0:  # 장애물 인식 1임무
            CWKIM_rotationEquationValue = 4.9  #3.75 #5.3
            CWKIM_forwardEquationValue = 80
            CWKIM_forwardMinimum = 55
            CWKIM_rotationMinimum = 40
            targetRange = 3.3
            arrivedRange = 1
            #forward_max = 110
            forward_max = 220
            rotation_max = 400
            CWKIM_rotationLimit = 38
        elif count_for_finalTarget == 1:
            CWKIM_rotationEquationValue = 3
            CWKIM_forwardEquationValue = 30
            CWKIM_forwardMinimum = 45
            CWKIM_rotationMinimum = 40
            targetRange = 3
            arrivedRange = 1
            forward_max = 60
            ...
            CWKIM_rotationEquationValue = 4.5 
            CWKIM_forwardEquationValue = 80
            ...
            cameraOn = False
            CWKIM_rotationEquationValue = 3.75
            CWKIM_forwardEquationValue = 20
            CWKIM_forwardMinimum = 50
            CWKIM_rotationMinimum = 50
            targetRange = 3
            arrivedRange = 1
            forward_max = 60
            rotation_max = 200
            CWKIM_rotationLimit = 35
        ...
        if(abs(angle_to_target) > CWKIM_rotationLimit):
            #forward = 0
            distance = 0
        ...
        if(CWKIM_arriveTarget == True):
            ...
            if (time.time() > CWKIM_rotationTime) and (abs(angle_to_finalTarget) < 30):
